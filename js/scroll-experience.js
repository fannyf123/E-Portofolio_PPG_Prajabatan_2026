...
function initScrollExperience() {
  ...
  // Sembunyikan scroll-rail jika halaman Semester 2 sedang tampil
  // (Semester 2 memakai nav bar kiri, bukan dot kanan).
  const s2ep1 = document.getElementById('s2ep1Wrapper');
  const s2ep2 = document.getElementById('s2ep2Wrapper');
  if ((s2ep1 && s2ep1.style.display === 'block') || (s2ep2 && s2ep2.style.display === 'block')) {
